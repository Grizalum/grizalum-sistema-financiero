...
// APLICAR ESTILOS DIRECTAMENTE AL BOTÓN DE NOTIFICACIONES
function aplicarEstilosBotonNotificaciones() {
    const boton = document.querySelector('.notification-center');
    if (boton) {
        ...
        boton.addEventListener('mouseenter', function() {
            this.style.background = 'linear-gradient(135deg, #e4c06a 0%, #d4af37 100%)';
        ...
        boton.addEventListener('mouseleave', function() {
            ...
            this.style.boxShadow = '0 4px 12px rgba(212, 175, 55, 0.25)';
        });
        
        console.log('✅ Estilos del botón aplicados directamente');
    }
}

// Ejecutar cuando el DOM esté listo
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(aplicarEstilosBotonNotificaciones, 1000);
});

// También ejecutar ahora por si acaso
aplicarEstilosBotonNotificaciones();
